...
def connect_basic():
    ...
    Logger.info(f"[basic] connected to {robot._robot_serial} ({robot._robot_type})")
    robot.close()
...
def connect_with_username_password():
    ...
    Logger.info(f"[user/pass] connected to {robot._robot_serial} ({robot._robot_type})")
    robot.close()
...
def connect_with_tls():
    ...
    Logger.info(f"[tls] connected to {robot._robot_serial} ({robot._robot_type})")
    robot.close()
...
def connect_with_mtls():
    ...
    robot = Robot.connect_mqtt("mqtts://10.231.0.2:8883", ROBOT_ID, options=options)
    Logger.info(f"[mtls] connected to {robot._robot_serial} ({robot._robot_type})")
    robot.close()
...
def connect_websocket_tls():
    ...
    Logger.info(f"[wss] connected to {robot._robot_serial} ({robot._robot_type})")
    robot.close()
...
def connect_full_options():
    ...
    Logger.info(f"[full] connected to {robot._robot_serial} ({robot._robot_type})")
    robot.close()
