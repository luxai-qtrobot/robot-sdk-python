...
QTROBOT_CORE_API_DOCS: Dict[str, str] = {
    ...
    "talking_behavior.set_source_config": (
        ...
        "    pitch_semitones (float): Optional pitch shift from -12.0 to 12.0; "
        "0.0 is unmodified. Applied from the next audio session and requires "
        "pitch support enabled for the lane in the service configuration.\n"
        "\n"
        "Returns:\n"
        "    bool: True on success, False on failure.\n"
        "\n"
    ...
    "talking_behavior.get_source_config": (
        ...
        "\n"
        "Returns:\n"
        "    dict: Contains source, lipsync, head_motion, arm_motion, and "
        "pitch_semitones.\n"
        "\n"
        "Example:\n"
